          ...
          >
            ...
            <div class="relative bg-[--vp-c-bg-alt] rounded-xl p-4">
              <div class="flex items-center justify-between mb-2">
                ...
                <button type="button"
                aria-label="Copy the Bedrock config"
          ...
          <div class="relative group">
            ...
            <div class="relative bg-[--vp-c-bg-alt] rounded-xl p-4">
              <div class="flex items-center justify-between mb-2">
                ...
                <button type="button"
                aria-label="Copy the Lite mode config"
...
/* Add transition for the copy icon.
   Declared before the .copy-success rules below so specificity ascends down the
   file (button svg is the least specific selector that matches the copy icon). */
button svg {

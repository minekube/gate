...
func init() {
	...
	empty(id("minecraft:nbt_compound_tag", mapSet(Minecraft_1_21_6, 21), mapSet(Minecraft_1_20_3, 20), mapSet(Minecraft_1_19, 19)))
	empty(id("minecraft:nbt_tag", mapSet(Minecraft_1_21_6, 22), mapSet(Minecraft_1_20_3, 21), mapSet(Minecraft_1_19, 20)))
	...
	empty(id("minecraft:angle", mapSet(Minecraft_1_21_6, 28), mapSet(Minecraft_1_20_3, 27), mapSet(Minecraft_1_19, 26)))
	...
	emptyWithCodec(id("minecraft:score_holder", mapSet(Minecraft_1_21_6, 31), mapSet(Minecraft_1_20_3, 30), mapSet(Minecraft_1_19, 29)), ByteArgumentPropertyCodec)
	...
	empty(id("minecraft:item_slots", mapSet(Minecraft_1_21_6, 35), mapSet(Minecraft_1_20_5, 34))) // added in 1.20.5
	empty(id("minecraft:resource_location", mapSet(Minecraft_1_21_6, 36), mapSet(Minecraft_1_20_5, 35), mapSet(Minecraft_1_20_3, 34), mapSet(Minecraft_1_19, 33)))
	empty(id("minecraft:mob_effect", mapSet(Minecraft_1_19_3, -1), mapSet(Minecraft_1_19, 34)))
	empty(id("minecraft:function", mapSet(Minecraft_1_21_6, 37), mapSet(Minecraft_1_20_5, 36), mapSet(Minecraft_1_20_3, 35), mapSet(Minecraft_1_19_3, 34), mapSet(Minecraft_1_19, 35)))
	empty(id("minecraft:entity_anchor", mapSet(Minecraft_1_21_6, 38), mapSet(Minecraft_1_20_5, 37), mapSet(Minecraft_1_20_3, 36), mapSet(Minecraft_1_19_3, 35), mapSet(Minecraft_1_19, 36)))
	empty(id("minecraft:int_range", mapSet(Minecraft_1_21_6, 39), mapSet(Minecraft_1_20_5, 38), mapSet(Minecraft_1_20_3, 37), mapSet(Minecraft_1_19_3, 36), mapSet(Minecraft_1_19, 37)))
	empty(id("minecraft:float_range", mapSet(Minecraft_1_21_6, 40), mapSet(Minecraft_1_20_5, 39), mapSet(Minecraft_1_20_3, 38), mapSet(Minecraft_1_19_3, 37), mapSet(Minecraft_1_19, 38)))
	...
	empty(id("minecraft:dimension", mapSet(Minecraft_1_21_6, 41), mapSet(Minecraft_1_20_5, 40), mapSet(Minecraft_1_20_3, 39), mapSet(Minecraft_1_19_3, 38), mapSet(Minecraft_1_19, 41)))
	empty(id("minecraft:gamemode", mapSet(Minecraft_1_21_6, 42), mapSet(Minecraft_1_20_5, 41), mapSet(Minecraft_1_20_3, 40), mapSet(Minecraft_1_19_3, 39)))
	emptyWithCodec(id("minecraft:time", mapSet(Minecraft_1_21_6, 43), mapSet(Minecraft_1_20_5, 42), mapSet(Minecraft_1_20_3, 41), mapSet(Minecraft_1_19_3, 40), mapSet(Minecraft_1_19, 42)), TimeArgumentPropertyCodec)
	register(id("minecraft:resource_or_tag", mapSet(Minecraft_1_21_6, 44), mapSet(Minecraft_1_20_5, 43), mapSet(Minecraft_1_20_3, 42), mapSet(Minecraft_1_19_3, 41), mapSet(Minecraft_1_19, 43)), RegistryKeyArgument, RegistryKeyArgumentPropertyCodec)
	register(id("minecraft:resource_or_tag_key", mapSet(Minecraft_1_21_6, 45), mapSet(Minecraft_1_20_5, 44), mapSet(Minecraft_1_20_3, 43), mapSet(Minecraft_1_19_3, 42)), ResourceOrTagKeyArgument, ResourceOrTagKeyArgumentPropertyCodec)
	register(id("minecraft:resource", mapSet(Minecraft_1_21_6, 46), mapSet(Minecraft_1_20_5, 45), mapSet(Minecraft_1_20_3, 44), mapSet(Minecraft_1_19_3, 43), mapSet(Minecraft_1_19, 44)), RegistryKeyArgument, RegistryKeyArgumentPropertyCodec)
	register(id("minecraft:resource_key", mapSet(Minecraft_1_21_6, 47), mapSet(Minecraft_1_20_5, 46), mapSet(Minecraft_1_20_3, 45), mapSet(Minecraft_1_19_3, 44)), ResourceKeyArgument, ResourceKeyArgumentPropertyCodec)
	register(id("minecraft:resource_selector", mapSet(Minecraft_1_21_6, 48), mapSet(Minecraft_1_21_5, 47)), ResourceSelectorArgument, ResourceSelectorArgumentPropertyCodec)

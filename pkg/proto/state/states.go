...
func init() {
	...
	Play.ClientBound.Register(&p.HeaderAndFooter{},
		m(0x47, Minecraft_1_8),
		m(0x48, Minecraft_1_9),
		m(0x47, Minecraft_1_9_4),
		m(0x49, Minecraft_1_12),
		m(0x4A, Minecraft_1_12_1),
		m(0x4E, Minecraft_1_13),
		m(0x53, Minecraft_1_14),
		m(0x54, Minecraft_1_15),
		m(0x53, Minecraft_1_16),
	)
	Play.ClientBound.Register(&p.PlayerListItem{},
		m(0x38, Minecraft_1_7_2),
		m(0x2D, Minecraft_1_9),
		m(0x2E, Minecraft_1_12_1),
		m(0x30, Minecraft_1_13),
		m(0x33, Minecraft_1_14),
		m(0x34, Minecraft_1_15),
		m(0x33, Minecraft_1_16),
		m(0x32, Minecraft_1_16_2),
	)
